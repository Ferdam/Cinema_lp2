...
public class SalaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(command);
            if ("addSala".equals(command)) {
                rd = request.getRequestDispatcher("addSala.jsp");
            } else if ("editSala".equals(command)) {
                rd = request.getRequestDispatcher("editSala.jsp");
            } else if ("remSala".equals(command)) {
                rd = request.getRequestDispatcher("remSala.jsp");
            }
